...
public class CountryCalculator {
     ...
     * @param countries The list of countries from which the country with the highest population density should be calculated
    ...
    public String findCountryWithHighestPopulationDensity(List<ReducedCountry> countries) {
        ...
        for (ReducedCountry reducedCountry : countries) {
            double populationDensity = calculatePopulationDensity(reducedCountry.getPopulation(), reducedCountry.getArea());
